...
class BannerVendedor(FloatLayout):
    ...
    def __init__(self, **kwargs):
        ...
        id_vendedor = kwargs["id_vendedor"]
          ...
          # obriga Regras na DB "indexOn": ["id_vendedor"]

        link = f'https://aplicativovendashash-39c91-default-rtdb.firebaseio.com/.json?orderBy="id_vendedor"&equalTo="{id_vendedor}"'
        requisicao = requests.get(link)
        requisicao_dic = requisicao.json()
            # retira somente o dicionário de valores do requisicao_dic que é uma lista de dicionarios
